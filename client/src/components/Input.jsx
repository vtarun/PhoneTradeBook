export default function Input({ id, label, type = "text", value, error, handleChange }) {
    ...
    const inputClass = `mt-1 w-full h-9 flex flex-col rounded-md border-2 border-gray-400 py-1 px-3 shadow-sm bg-gray-400 text-black ${type === 'date' ? 'text-xs py-2 px-2' : ''}`;
